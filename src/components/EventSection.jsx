...
const gridEvents = events.filter((e) => e.cardImage);
  ...
  return (
    <section className="events-wrapper relative overflow-hidden bg-black px-4 md:px-8 xl:px-16 py-20 md:py-28">
      ...
      <div className="events-heading relative z-[2] text-center mb-14 md:mb-20">
        ...
        <div className="overflow-hidden">
          <h2
            className="heading-line text-white text-[clamp(3rem,8vw,8rem)] leading-[0.85] uppercase tracking-[-0.06em] font-black"
            style={{
              fontFamily:
      ...
      <div className="relative z-[2] grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 md:gap-7">
        {gridEvents.map((event) => (
          <div
            ...
            className="event-card group cursor-pointer relative overflow-hidden border border-red-500/20 bg-black/60 backdrop-blur-sm"
          >
            {/* Image */}
            ...
            <div className="relative h-[240px] overflow-hidden">
              <img
                src={event.cardImage}
                alt={event.title}
                className="event-image absolute inset-0 h-full w-full object-cover brightness-[0.45] contrast-[1.1] transition-transform duration-700 group-hover:scale-105"
              />
            ...
            <div className="p-5 md:p-6">
              ...
              <h3
                className="text-white text-4xl md:text-5xl leading-[0.9] uppercase tracking-[-0.04em] font-black"
                style={{
                  fontFamily:
                    'Impact, Haettenschweiler, "Arial Narrow Bold", sans-serif',
                }}
              ...
              <div className="mt-8 flex items-center justify-between">
                <button
                  onClick={() => navigate(`/event/${event.id}`)}
                  className="border border-red-500/30 px-4 py-2 text-[10px] md:text-xs uppercase tracking-[0.25em] text-red-500 font-mono transition-all duration-300 group-hover:bg-red-500 group-hover:text-black"
                >
                  Enter Event
                </button>
